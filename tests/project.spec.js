...
const ProjectList = require(path.resolve(
    __dirname,
    '../compiled/ProjectList.json'
))
...
describe('Project Contract', () => {
    ...
    beforeEach(async () => {
        ...
        projectList = await new web3.eth.Contract(
        ...
        await projectList.methods
            .createProject('Ethereum DApp Tutorial', 100, 10000, 1000000)
            .send({
                from: accounts[0],
                gas: '3000000'
            })
    ...
    it('should allow owner to create payment', async () => {
        ...
        await project.methods
            .createPayment('Rent Office', '500', receiver)
            .send({
                from: owner,
                gas: '1000000'
            })
    ...
    it('allows investor to approve payments', async () => {
        ...
        // 资金支出请求
        await project.methods
            .createPayment('Rent Office', 2000, receiver)
            .send({
                from: owner,
                gas: '1000000'
            })
